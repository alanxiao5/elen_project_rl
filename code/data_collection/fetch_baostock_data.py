...
class DataManager:
    ...
    def _load_all_a_shares_base(self) -> None:
        if os.path.exists(self._a_shares_list_path):
            ...
            lines = _read_all_text(fr"{self._qlib_path}\instruments\all.txt").split('\n')
...
if __name__ == "__main__":
    ...
    dm = DataManager(
        save_path=r"~\.qlib/tmp",
        qlib_export_path=r"~\.qlib\qlib_data\cn_data_rolling",
        qlib_base_data_path=r"~\.qlib\qlib_data\cn_data",
